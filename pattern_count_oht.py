...
def check_bounds(counts):
    if (counts[0] <= 96) or (counts[0] >= 159):
        return False
    if (counts[1] <= 44) or (counts[1] >= 87):
        return False
    if (counts[2] <= 9) or (counts[2] >= 58):
        return False
    if (counts[3] <= 4) or (counts[3] >= 35):
        return False
    if (counts[4] <= 9) or (counts[4] >= 58):
        return False
    if (counts[5] <= 4) or (counts[5] >= 35):
        return False
    return True
